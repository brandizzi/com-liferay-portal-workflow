...
public class WorkflowPortlet extends MVCPortlet {
	...
	public void render(
		...
		prepareWorkflowInstanceDisplay(renderRequest);
	...
	protected void prepareWorkflowDefinitionDisplay(
			RenderRequest renderRequest, RenderResponse renderResponse)
	...
	protected void prepareWorkflowInstanceDisplay(RenderRequest renderRequest)
		throws PortletException {
