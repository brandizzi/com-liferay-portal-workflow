...
<aui:nav-bar cssClass="collapse-basic-search container-fluid" markupView="lexicon">
	<aui:nav cssClass="navbar-nav">
		<portlet:renderURL var="workflowRenderURL">
			<portlet:param name="tab" value="workflows" />
		</portlet:renderURL>

		<aui:nav-item
			href="<%= workflowRenderURL.toString() %>"
			label="workflows"
			selected='<%= tab.equals("workflows") %>'
		/>

		<portlet:renderURL var="schemesRenderURL">
			<portlet:param name="tab" value="schemes" />
		</portlet:renderURL>

		<aui:nav-item
			href="<%= schemesRenderURL.toString() %>"
			label="schemes"
			selected='<%= tab.equals("schemes") %>'
		/>
		...
		<aui:nav-item
			...
			label="monitoring"
			selected='<%= tab.equals("monitoring") %>'
		/>
	</aui:nav>
