...
<aui:nav-bar cssClass="collapse-basic-search" markupView="lexicon">
	<aui:nav cssClass="navbar-nav">
		...
		%>
			...
			<portlet:renderURL var="workflowPortletTabRenderURL">
				<portlet:param name="tab" value="<%= workflowPortletTab.getName() %>" />
			</portlet:renderURL>

			<aui:nav-item
				href="<%= workflowPortletTabRenderURL.toString() %>"
				label="<%= workflowPortletTab.getLabel() %>"
				selected="<%= workflowPortletTab.getName().equals(selectedWorkflowPortletTab.getName()) %>"
			/>
